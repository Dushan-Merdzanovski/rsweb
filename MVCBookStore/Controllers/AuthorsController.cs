    ...
    public class AuthorsController : Controller
    {
        ...
        /*public async Task<IActionResult> Index()
        {
              return _context.Author != null ? 
                          ...
                          Problem("Entity set 'MVCBookStoreContext.Author'  is null.");
        }*/
        ...
        public async Task<IActionResult> Index(string searchString)
        {
            ...
            {
                authors = authors.Where(s => s.FirstName.Contains(searchString) || s.Nationality.Contains(searchString) || s.LastName.Contains(searchString));
            }
